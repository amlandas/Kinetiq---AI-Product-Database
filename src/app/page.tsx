...
export default function Home() {
    ...
    useEffect(() => {
        ...
        if (tabParam && ['products', 'comparison', 'analytics', 'matchmaker'].includes(tabParam)) {
    ...
    const filteredProducts = useMemo(() => {
        let result = allProducts.filter(product => {
            ...
            if (filters.dateRange.start || filters.dateRange.end) {
                ...
                if (filters.dateRange.start) matchesDate = matchesDate && productDate >= new Date(filters.dateRange.start);
                if (filters.dateRange.end) matchesDate = matchesDate && productDate <= new Date(filters.dateRange.end);
            }
